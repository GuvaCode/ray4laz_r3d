...
cmake .. -DR3D_RAYLIB_VENDORED=ON -DR3D_ASSIMP_VENDORED=ON -DBUILD_SHARED_LIBS=ON -DR3D_BUILD_EXAMPLES=OFF
cmake --build .
...
cmake .. -DR3D_RAYLIB_VENDORED=ON -DR3D_ASSIMP_VENDORED=ON -DBUILD_SHARED_LIBS=OFF -DR3D_BUILD_EXAMPLES=OFF
cmake --build .
...
cmake .. -DCMAKE_TOOLCHAIN_FILE=cmake/mingw-w64-x86_64.cmake -DR3D_RAYLIB_VENDORED=ON -DR3D_ASSIMP_VENDORED=ON -DBUILD_SHARED_LIBS=ON -DR3D_BUILD_EXAMPLES=OFF
cmake --build .

...
var
  ...
  begin
    ...
    DrawRectangle(10, 10, 450, 420, Fade(BLACK, 0.7));
    DrawRectangleLines(10, 10, 450, 420, WHITE);
...
begin
  ...
  // Создаем skybox
  skyCustom := R3D_GenCustomSky(1024, shader);
  ...
  begin
    ...
    BeginDrawing();
      ...
      DrawText(TextFormat('Seed: %.4f', seed), 10, screenHeight - 50, 20, DARKGREEN);  // Изменен формат
